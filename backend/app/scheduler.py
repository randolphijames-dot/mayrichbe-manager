...
def _publish_instagram(task, account, material, db):
    ...
    try:
        ...
        from app.core.windows_runtime import format_playwright_runtime_error
        ...
        user_facing_error = format_playwright_runtime_error(e) or str(e)
        task.status = TaskStatus.FAILED
        task.error_message = user_facing_error[:500]
        db.commit()
        raise RuntimeError(user_facing_error) from e
